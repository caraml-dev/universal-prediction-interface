...
| values | [Value](#caraml-upi-v1-Value) | repeated | List of values within a row. It is table&#39;s creator responsibility to ensure that the length of this field matches with the number of columns in the table. |
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| double_value | [double](#double) |  | Double precision floating number (64-bit). Should be set when the column type is TYPE_DOUBLE |
| integer_value | [int64](#int64) |  | 64-bit Integer value. Should be set when the column type is TYPE_INTEGER |
| string_value | [string](#string) |  | String value. Should be set when the column type is TYPE_STRING |
...
| type | [Type](#caraml-upi-v1-Type) |  | Type of the variable. One of double_value, integer_value, and string_value field should be set depending on the type. |
| double_value | [double](#double) |  | Double precision floating number (64-bit). Should be set when the variable type is TYPE_DOUBLE |
| integer_value | [int64](#int64) |  | 64-bit Integer value. Should be set when the variable type is TYPE_INTEGER |
| string_value | [string](#string) |  | String value. Should be set when the variable type is TYPE_STRING |
